...
3. Extract the zip file and find the Server Manager executable for your operating system. Replace your current Server Manager
   executable with it.
...
6. Start the new Server Manager executable.
